...
Flat.create!(
  name: 'Stunning Kensington Garden Facing Apartment',
  address: 'Near Westfield, Greater London',
  description: 'This mezzanine flat is modern and clean. Excellent choice for groups (no parties are allowed though) and families.',
  price_per_night: 110,
  number_of_guests: 4
  )
